...
-- shared gold
SHARED_GOLD_PERCENTAGE = 0.60
SHARED_MISSED_GOLD_PERCENTAGE = 0.25
...
POG_UPGRADED_DAMAGE_ADD = 1
POG_MEGA_DAMAGE_ADD = 3
POG_UPGRADED_HEALTH_ADD = 8
POG_MEGA_HEALTH_ADD = 30
