...
function barebones:setup_jungle()
    ...
    Timers:CreateTimer(2, function()
        -- Entities:FindByName(nil, "npc_dota_goodguys_healers"):SetTeam(2)
        -- Entities:FindByName(nil, "npc_dota_goodguys_healers"):FindAbilityByName("filler_ability"):EndCooldown()
        -- Entities:FindByName(nil, "npc_dota_goodguys_healers"):FindAbilityByName("filler_ability"):StartCooldown(POG_SHRINE_INITIAL_CD)
	end)
    Timers:CreateTimer(2, function()
        -- Entities:FindByName(nil, "npc_dota_badguys_healers"):SetTeam(3)
        -- Entities:FindByName(nil, "npc_dota_badguys_healers"):FindAbilityByName("filler_ability"):EndCooldown()
        -- Entities:FindByName(nil, "npc_dota_badguys_healers"):FindAbilityByName("filler_ability"):StartCooldown(POG_SHRINE_INITIAL_CD)
    end)
